...
//   handleItemsChange = (it) => {
//       if(it.length != 0){
//           console.log(it)
//    const slug =  makeSlug(it[0].value, it[0].id)
...
//         let items = posts.data[0].map( (res, i) => {
//           //  return { id: res.id, value: res.title } 
//           const slug =  makeSlug(res.title, res.id)
//           return  <Link href={`/post/${slug}`} key={res.id}>
//                  <ListItem button>{res.title}</ListItem>
//                 </Link>
//           })
//         this.setState({ repos: items })
...
//         </div>
//       </div>
//         {/* <Search   items={this.state.posts}
//                 multiple={false}
//                 getItemsAsync={this.getSearch}
//                 onItemsChanged={this.handleItemsChange}
//                  /> */}
//       </div>
//     )
...
import {
  ...
  ResultsNumberMobile,
  SaveFiltersMobile,
} from './instasearch/widgets';
import withURLSync from '../URLSync';
import { formatNumber } from '../utils';

import AlgoliaSvg from '../AngoliaSvg';
