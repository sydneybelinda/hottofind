...
function Messages(props) {
  ...
  const total = props.messages.count || 0;
          ...
          <Grid container>
            <Grid item md={6}>
              <div className={classes.mainFeaturedPostContent}>
                <h1 className={classes.sitename}>Dashboard - Messages</h1>
              </div>
            </Grid>
          </Grid>
        </Container>
        ...
        <div className={classes.right}>
          ...
          <Grid container spacing={4} className={classes.grid}>
            ...
            <Grid item xs={12} md={12}>
              <Sort total={total} defaultDashSort={props.defaultMessageSort} />
              <Divider />
            </Grid>
            {props.messages.rows.length > 0
              ? props.messages.rows.map(message => (
                  <Grid className={classes.gitem} item key={message.id} xs={12}>
                    <Message message={message} user={props.user} openModal={openModal} closeModal={closeModal} />
                  </Grid>
                ))
...
Messages.getInitialProps = async ctx => {
  ...
  if (user) {
    ...
    return {
      ...
      //        page: data.page,
      query: ctx.query,
      defaultMessageSort: defaultMessageSort
    };
  }
};
